...
if "`data'"=="bg" {
merge 1:1 gvkey year using "$data/bg_compustat_`cut'cutoff", keepus(njob njob_narrowai) keep(1 3) nogen
...
esttab using "$table/original/table_ols_bg`cut'cutoff.tex", replace label f booktabs style(tex) alignment (c) nofloat ///
